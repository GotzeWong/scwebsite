					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="has-sub">
								...
								<i class="fa fa-handshake-o fa-fw"></i> <span class="menu-text">申请表</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="/listincubator"><span class="sub-menu-text">孵化器</span></a></li>
									<li><a class="" href="/listalliance"><span class="sub-menu-text">产业联盟</span></a></li>
								</ul>
							</li>
							<li class="has-sub">
								<a href="javascript:;" class="">
								<i class="fa fa-user fa-fw"></i> <span class="menu-text">用户管理</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="/listuser?role=1"><span class="sub-menu-text">管理员</span></a></li>
									<li><a class="" href="/listuser?role=0"><span class="sub-menu-text">用户</span></a></li>
								</ul>
							</li>
							
							<li class="has-sub">
								<a href="javascript:;" class="">
								<i class="fa fa-shopping-cart fa-fw"></i> <span class="menu-text">商城管理</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="/product/list"><span class="sub-menu-text">商品</span></a></li>
								</ul>
							</li>
							
							<li class="has-sub">
								<a href="javascript:;" class="">
								<i class="fa fa-shopping-cart fa-fw"></i> <span class="menu-text">订单管理</span>
								<span class="arrow"></span>
								</a>
								<ul class="sub">
									<li><a class="" href="/order/list?status=0"><span class="sub-menu-text">未完成订单</span></a></li>
									<li><a class="" href="/order/list?status=1"><span class="sub-menu-text">已完成订单</span></a></li>
								</ul>
							</li>
						</ul>
						<!-- /SIDEBAR MENU -->
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">孵化器</h3>
									</div>
									<div class="description">共 ${fn:length(requestScope.incubatorArray)}条</div>
								</div>
							</div>
						</div>
						<!-- DARK & STATS -->
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover">
										 <thead>
											<tr>
												<th><i class="fa fa-user"></i>  项目名称</th>

												<th><i class="fa fa-location-arrow"></i>  所属行业</th>

												<th><i class="fa fa-user"></i>  负责人</th>

												<th><i class="fa fa-phone"></i>  手机</th>

												<th><i class="fa fa-envelope"></i>  邮箱</th>

												<th><i class="fa fa-edit"></i>  项目简介</th>
												
												<th><i class="fa fa-location-arrow"></i>  地址</th>
												<th><i class="fa fa-edit"></i>  公司名称</th>
												<th><i class="fa fa-edit"></i> 创始人名称</th>
												<th><i class="fa fa-edit"></i>  手机</th>
												<th><i class="fa fa-edit"></i>  邮箱</th>
												
												<th><i class="fa fa-weixin"></i> 微信</th>
												<th><i class="fa fa-edit"></i> 融资信息</th>
												<th><i class="fa fa-edit"></i> 融资轮次</th>
												
												<th><i class="fa fa-calendar"></i>  提交时间</th>
												
												<th><i class="fa fa-download"></i>  资料</th>
											</tr>
										 </thead>
										 <tbody>
										 
											<c:forEach items="${requestScope.incubatorArray}" var="applicant">
												<tr>
												   <td>${applicant.project_name}</td>
												   ...
												   <td>${applicant.province} ${applicant.city}</td>
												   <td>${applicant.company_name}</td>
												   <td>${applicant.founder_name}</td>
												   <td>${applicant.founder_phone}</td>
												   <td>${applicant.founder_email}</td>
												   <td>${applicant.founder_wechat}</td>
												   <td>${applicant.financing_round}</td>
												   <td>${applicant.valuation}</td>
												   <td>${applicant.created}</td>
												   <td><span class="label label-success label-sm"><a href="/download?id=${applicant.id}">下载</a></span></td>
												</tr>
											</c:forEach>
