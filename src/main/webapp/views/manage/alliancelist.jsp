						...
						<div class="row">
							<div class="col-sm-12">
								<div class="page-header">
									...
									<!-- /BREADCRUMBS -->
									<div class="clearfix">
										<h3 class="content-title pull-left">产业联盟</h3>
									</div>
									<div class="description">共 ${fn:length(requestScope.allianceArray)} 条</div>
								</div>
							</div>
						</div>
						<!-- DARK & STATS -->
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover">
										 <thead>
											<tr>
												<th><i class="fa fa-navicon"></i>  类型</th>
												<th><i class="fa fa-user"></i>  姓名</th>

												<th><i class="fa fa-phone"></i>  联系方式</th>

												<th><i class="fa fa-envelope"></i>  Email</th>

												<th><i class="fa fa-edit"></i>  公司简称</th>

												<th><i class="fa fa-edit"></i>  公司全称</th>
												
												<th><i class="fa fa-edit"></i>  描述</th>
												
												<th><i class="fa fa-edit"></i>  主营业务</th>
												
												<th><i class="fa fa-headphones"></i>  服务号码</th>
										 ...
										 <tbody>
											...
											<c:forEach items="${requestScope.allianceArray}" var="applicant">
												<tr>
												   <td>

										 			<c:if test="${applicant.type_manufactor == '1'}">
													   生产制造商  
													 </c:if>
													 
										 			<c:if test="${applicant.type_supplychain == '1'}">
												   		供应链
													 </c:if>
													 
										 			<c:if test="${applicant.type_finance == '1'}">
												   		投融资方
													 </c:if>
													 
										 			<c:if test="${applicant.type_market == '1'}">
												   		市场渠道
													 </c:if>
												   ...
												   <td>${applicant.company_shortname}</td>
												   <td>${applicant.company_fullname}</td>
												   <td>${applicant.company_description}</td>
												   <td>${applicant.company_main_business}</td>
												   <td>${applicant.service_number}</td>
