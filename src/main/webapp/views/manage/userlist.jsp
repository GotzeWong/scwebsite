					...
					<div class="sidebar-menu nav-collapse">
						...
						<ul>
							...
							<li class="has-sub">
								...
								<i class="fa fa-bookmark-o fa-fw"></i> <span class="menu-text">平台合作</span>
							...
							<div class="col-sm-12">
								<div class="page-header">
									...
									<ul class="breadcrumb">
										...
										<li>
										<c:if test="${requestScope.role==1 }">管理员</c:if>
										<c:if test="${requestScope.role==0 }">用户</c:if>
									...
									<div class="clearfix">
										...
										<c:if test="${requestScope.role==1 }">管理员</c:if>
										<c:if test="${requestScope.role==0 }">用户</c:if></h3>
									</div>
									<div class="description">共 ${fn:length(requestScope.personArray)}条</div>
								</div>
							</div>
						</div>
						<!-- DARK & STATS -->
									...
									<div class="panel-body">
										<table class="table table-striped table-bordered table-hover">
										 ...
										 <tbody>
											...
											<c:forEach items="${requestScope.personArray}" var="user">
												<tr>
												   <td>${user.id}</td>
												   <td>${user.username}</td>
												   <td>${user.password}</td>
