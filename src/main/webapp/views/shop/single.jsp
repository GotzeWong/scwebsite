...
<link href="/css/shop/form.css" rel="stylesheet" type="text/css" media="all" />
...
<!-- end menu -->
<script type="text/javascript" src="/js/shop/jquery.jscrollpane.min.js"></script>
...
<!----details-product-slider--->
				<!-- Include the Etalage files -->
					<link rel="stylesheet" href="/css/shop/etalage.css">
					<script src="/js/shop/jquery.etalage.min.js"></script>
				<!-- Include the Etalage files -->
				<script>
