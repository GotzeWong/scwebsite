					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box-plain">
								<h6 style="text-align:center;"><img style="display: inline-block;height:80px;" src="/img/icon/black/idea.png" class="img-certification"></h6>
								<h2 class="bigintro">创意合作</h2>
								...
								<form role="form" enctype="multipart/form-data" action="addapplicant" method="post">
								  ...
								  <div class="form-group"> 
									<label for="exampleInputPassword2">创意描述</label>
								  ...
								  <input style="height:0px;visibility: hidden;" name="type" type="text" value="1" >
