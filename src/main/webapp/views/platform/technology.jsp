					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box-plain">
								...
								<h6 style="text-align:center;"><img style="display: inline-block;height:80px;" src="/img/icon/black/chip.png" class="img-certification"></h6>
								<h2 class="bigintro">技术合作</h2>
								<h5 style="text-align:center;">- 源代码科技 -</h5>
								<div class="divide-40"></div>
								<form role="form" enctype="multipart/form-data" action="addapplicant" method="post">
								  <div class="form-group">
									<label for="exampleInputName">公司/姓名</label>
								  ...
								  <div class="form-group">
									...
									<input type="text" name="addr" class="form-control" id="exampleInputName" >
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group"> 
									<label for="exampleInputPassword2">技术描述</label>
								  ...
								  <input style="height:0px;visibility: hidden;" name="type" type="text" value="0" >
