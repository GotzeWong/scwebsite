...
<body class="login">	
					...
					<div class="row">
						<div class="col-md-4 col-md-offset-4">
							<div class="login-box-plain">
								<h6 style="text-align:center;"><img style="display: inline-block;height:80px;" src="/img/icon/black/chart.png" class="img-certification"></h6>
								<h2 class="bigintro">市场合作</h2>
								<h5 style="text-align:center;">- 源代码科技 -</h5>
								<div class="divide-40"></div>
								<form role="form" enctype="multipart/form-data" action="addapplicant" method="post">
								  <div class="form-group">
									<label for="exampleInputName">公司名称/个人</label>
								  ...
								  <div class="form-group"> 
									<label for="exampleInputPassword2">渠道描述</label>
								  ...
								  <input style="height:0px;visibility: hidden;" name="type" type="text" value="3" >
	...
	<script>
		jQuery(document).ready(function() {		
			App.setPage("marketing");  //Set current page
